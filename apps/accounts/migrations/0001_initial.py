    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('Admin', 'Admin'), ('Superadmin', 'Superadmin'), ('Supervisor', 'Supervisor'), ('Biller', 'Biller'), ('Staff', 'Staff'), ('Supplier', 'Supplier'), ('Customer', 'Customer')], max_length=20)),
